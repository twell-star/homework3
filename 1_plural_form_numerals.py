...
def plural_form(num, form1, form2, form3):
    ...
    :param form3: согласующаяся текстовая форма для множества 0 и от 5 до 9 включительно и множеств, заканчивающихся на эти цифры, а также для (12, 13, 14)
    """
    ...
    if (type(num) == int) and (num >= 0):    # проверка на целочисленность и положительность
        if (num in [0, 5, 6, 7, 8, 9, 11, 12, 13, 14]) or (int(num - (num//10)*10) in [0, 5, 6, 7, 8, 9]):   # проверка значения 'num' на соответствие 'form3' 
            form_out = form3
